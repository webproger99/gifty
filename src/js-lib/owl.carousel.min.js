...
!(function (a, b, c, d) {
  ...
  function e(b, c) { let e = !1; const f = b.charAt(0).toUpperCase() + b.slice(1); return a.each((`${b} ${h.join(`${f} `)}${f}`).split(" "), function (a, b) { if (g[b] !== d) return e = !c || b, !1; }), e; } function f(a) { return e(a, !0); } var g = a("<support>").get(0).style; var h = "Webkit Moz O ms".split(" "); const i = {
    transition: {
      end: {
